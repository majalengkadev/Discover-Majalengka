...
class ErrorLayout extends StatelessWidget {
  ...
  factory ErrorLayout.error(dynamic error,
    ...
    if (error is SocketException || error is TimeoutException) {
      title = "Tidak ada sambungan internet";
      desc =
          "Silakan periksa kuota data atau sambungan Wi-Fi anda, dan coba lagi";
      icon = Icons.signal_wifi_off;
    } else if (error is NullThrownError) {
      title = "Data tidak ditemukkan";
      desc = "";
      icon = Icons.mood_bad;
      enableButton = false;
    ...
    return Center(
      child: Padding(
          ...
          child: Column(
            ...
            children: [
              icon != null
                  ? Icon(icon, size: 48.0, color: const Color(0xff849dfe))
                  : Container(),
